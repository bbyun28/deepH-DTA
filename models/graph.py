...
class HGAN(nn.Module):
    def __init__(self, num_meta_paths, in_size, hidden_size, out_size, num_heads, dropout):
        ...
        self.layers.append(HGANLayer(num_meta_paths, in_size, hidden_size, num_heads[0], dropout))
        for l in range(1, len(num_heads)):
            self.layers.append(HGANLayer(num_meta_paths, hidden_size * num_heads[l-1],
